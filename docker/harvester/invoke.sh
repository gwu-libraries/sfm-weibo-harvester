...
exec gosu sfm python weibo_harvester.py --debug=$DEBUG --debug-warcprox=$DEBUG_WARCPROX service $SFM_RABBITMQ_HOST $SFM_RABBITMQ_USER $SFM_RABBITMQ_PASSWORD /sfm-containers-data/containers/$HOSTNAME --tries=$HARVEST_TRIES
